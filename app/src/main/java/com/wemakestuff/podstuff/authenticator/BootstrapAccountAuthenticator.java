...
import static com.wemakestuff.podstuff.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {
	...
	/**
	 * This method gets called when the {@link com.wemakestuff.podstuff.authenticator.ApiKeyProvider#getAuthKey()}
	 * methods gets invoked. This happens on a different process, so debugging it can be a beast.
	 *
	 * @param response
	 * @param account
	 * @param authTokenType
