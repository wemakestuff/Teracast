...
import static com.wemakestuff.podstuff.core.Constants.Http.*;
...
public class BootstrapAuthenticatorActivity extends SherlockAccountAuthenticatorActivity {
	...
	/**
	 * In this instance the token is simply the sessionId returned from Parse.com. This could be a oauth token or some
	 * other type of timed token that expires/etc. We're just using the parse.com sessionId to prove the example of how
	 * to utilize a token.
	 */
