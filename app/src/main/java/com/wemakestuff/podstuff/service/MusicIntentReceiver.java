...
/**
 * Receives broadcasted intents. In particular, we are interested in the android.media.AUDIO_BECOMING_NOISY and
 * android.intent.action.MEDIA_BUTTON intents, which is broadcast, for example, when the user disconnects the
 * headphones. This class works because we are declaring it in a &lt;receiver&gt; tag in AndroidManifest.xml.
 */
