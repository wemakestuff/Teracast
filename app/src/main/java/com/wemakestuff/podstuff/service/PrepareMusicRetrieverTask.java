...
/**
 * Asynchronous task that prepares a MusicRetriever. This asynchronous task essentially calls {@link
 * MusicRetriever#prepare()} on a {@link MusicRetriever}, which may take some time to run. Upon finishing, it notifies
 * the indicated {@MusicRetrieverPreparedListener}.
 */
