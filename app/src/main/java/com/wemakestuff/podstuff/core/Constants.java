...
public class Constants {
	...
	public static class Auth {
		 ...
		 * Account type id
		 */
		public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.wemakestuff.podstuff";
		 ...
		 * Provider id
		 */
		public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.wemakestuff.podstuff.sync";
