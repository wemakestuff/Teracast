...
public class HttpService extends IntentService {
	...
	public static final String USER_AGENT         = "PodStuff by WeMakeStuff";
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (intent == null) {
			Log.e(TAG, "onHandleIntent - Intent was null, unable to continue.");
		}
		...
		try {
			...
			if (request != null) {
				...
				if (userAgent != null)
					request.addHeader("User-Agent", HttpService.USER_AGENT);
